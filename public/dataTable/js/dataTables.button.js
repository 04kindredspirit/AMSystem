    ...
    DataTable.Api.register("buttons.info()", function (title, message, time) {
        ...
        _fadeIn(
            $('<div id="datatables_buttons_info" class="dt-button-info"/>')
                ...
                .append(
                    $("<div/>")[
                        typeof message === "string" ? "html" : "append"
                    ](message)
                )
                .css("display", "none")
                .appendTo("body")
