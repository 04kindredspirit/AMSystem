...
!(function (e) {
    ...
    function w(t, i, e, n, s, r) {
        ...
        if (
            ...
            (this.dom = {
                ...
                ).html(this.s.dt.i18n("searchBuilder.condition", i.condition)),
                ...
                dataTitle: I(
                    '<option value="" disabled selected hidden/>'
                ).html(this.s.dt.i18n("searchBuilder.data", i.data)),
                ...
                left: I("<button/>")
                    ...
                    .attr(
                        "title",
                        this.s.dt.i18n("searchBuilder.leftTitle", i.leftTitle)
                    )
                    .attr("type", "button"),
                right: I("<button/>")
    ...
    function n(t, i) {
        ...
        if (
            ...
            return (
                (t.settings()[0]._searchBuilder = this).s.dt.page.info()
                    .serverSide &&
                    (this.s.dt.on("preXhr.dtsb", function (t, i, e) {
                        var n = s.s.dt.state.loaded();
                        n &&
                            n.searchBuilder &&
                            (e.searchBuilder = s._collapseArray(
                                n.searchBuilder
                            ));
                    }),
    ...
    return (
            ...
            if (
                ...
                t.data !== V &&
                    ...
                    this.dom.data.children("option").each(function () {
                        ...
                        (I(this).text() === t.data ||
                            (t.origData &&
                                I(this).prop("origData") === t.origData))
                ...
                for (
                    var r = void 0,
                        o = this.dom.condition.children("option"),
                        a = 0;
                    a < o.length;
                    a++
                ) {
        ...
        (w.prototype.setListeners = function () {
            ...
            this.dom.data.unbind("change").on("change.dtsb", function () {
                ...
                for (
                    var t = l.dom.data.children("option." + l.classes.option),
                        i = 0;
                    i < t.length;
                    i++
                ) {
                ...
                this.dom.condition
                    ...
                    .on("change.dtsb", function () {
                        ...
                        for (
                            var t = l.dom.condition.children(
                                    "option." + l.classes.option
                                ),
                                i = 0;
                            i < t.length;
                            i++
                            ...
                            if (e.val() === l.dom.condition.val()) {
                                ...
                                for (
                                    ...
                                    l.s.filled &&
                                        d !== V &&
                                        0 !==
                                            l.dom.inputCont.has(d[0]).length &&
                                        ((l.s.filled = !1),
                                        l.s.dt.draw(),
                                        l.setListeners());
                                }
                                (0 === l.dom.value.length ||
                                    (1 === l.dom.value.length &&
                                        l.dom.value[0] === V)) &&
                                    l.s.dt.draw();
        ...
        (w.prototype._populateCondition = function () {
            ...
            if (0 === i) {
                ...
                var s = this.s.dt.settings()[0].oLanguage.sDecimal,
                    r =
                        ("" !== s &&
                            this.s.type.indexOf(s) ===
                                this.s.type.length - s.length &&
                ...
                this.dom.condition
                    ...
                    .addClass(this.classes.italic);
                for (
                    var l = 0, u = Object.keys(this.s.conditions);
                    l < u.length;
                    l++
                ) {
                    var c = u[l],
                        h =
                            ("function" ==
                                typeof (y =
                                    this.s.conditions[c].conditionName) &&
                                (y = y(this.s.dt, this.c.i18n)),
                            I("<option>", { text: y, value: c })
                                .addClass(this.classes.option)
                                .addClass(this.classes.notItalic));
                ...
                if ("number" == typeof f)
                    ...
                    for (var g = 0; g < t.length; g++)
                        for (
                            ...
                            if (
                                ("string" ==
                                typeof (y = this.s.conditions[C].conditionName)
                                    ? y
                                    : y(this.s.dt, this.c.i18n)) ===
                                    t[g].text() &&
                                C === f
                            ) {
                                this.dom.condition
            ...
            if (
                ...
                this.s.dt.columns().every(function (t) {
                    if (
                        ...
                        for (
                            var i, e, n = !1, s = 0, r = o.s.dataPoints;
                            s < r.length;
                            s++
                        )
                            if (r[s].index === t) {
                        ...
                        n ||
                            ((e = {
                                index: t,
                                origData: (i =
                                    o.s.dt.settings()[0].aoColumns[t]).data,
                ...
                for (
                    var i = this, t = 0, e = this.s.dataPoints;
                    t < e.length;
                    t++
                )
                    !(function (e) {
        ...
        (w.prototype._populateValue = function (i) {
            ...
            if (1 < r.length)
                for (var o = 0; o < r.length; o++) I(r[o]).remove();
            i !== V &&
                this.s.dt.columns().every(function (t) {
        ...
        (w.initSelect = function (e, t, n, i) {
            ...
            for (
                ...
                var h = c[u],
                    ...
                    f =
                        ("array" === e.s.type &&
                            ((m.filter = Array.isArray(m.filter)
                                ? m.filter
                                : [m.filter]),
                            (m.text = Array.isArray(m.text)
                                ? m.text
                                : [m.text])),
                        function (t, i) {
                ...
                if (i)
                    ...
                    f(
                        m.filter,
                        Array.isArray(m.text) ? m.text.join(", ") : m.text
                    );
            }
            l.sort(function (t, i) {
        ...
        (w.inputValueSelect = function (t) {
            for (var i = [], e = 0, n = t; e < n.length; e++) {
                ...
                s.is("select") &&
                    i.push(
                        w._escapeHTML(s.children("option:selected").data("sbv"))
                    );
            }
            return i;
        }),
                ...
                for (var t = 0; t < this.s.criteria.length; t++) {
                    ...
                    i instanceof c
                        ? ((this.s.criteria[t].index = t),
                          ...
                          this.s.criteria[
                              t
                          ].criteria.dom.container.insertBefore(this.dom.add),
        ...
        (g.prototype.setupLogic = function () {
            if (
                ...
                this.dom.logicContainer.offset({ top: n - (n - s) }),
                    this.dom.clear.outerHeight(
                        this.dom.logicContainer.height()
                    ),
        ...
        (g.prototype.setListeners = function () {
            ...
            this.dom.add.unbind("click"),
                this.dom.add.on("click.dtsb", function () {
                    return (
                        t.s.isChild ||
                            t.dom.container.prepend(t.dom.logicContainer),
                        t.addCriteria(),
            ...
            for (
                ...
                0 === s && this.s.criteria[s].criteria.s.index > e.s.index
                    ? (e
                          .getNode()
                          .insertBefore(
                              this.s.criteria[s].criteria.dom.container
                          ),
                      (n = !0))
        ...
        (n.prototype._applyPreDefDefaults = function (t) {
            for (
                var e = this,
                    n =
                        (t.criteria !== V && t.logic === V && (t.logic = "AND"),
                        this),
                    i = 0,
                    s = t.criteria;
                i < s.length;
                ...
                !(function (i) {
                    i.criteria !== V
                        ...
                        : n.s.dt.columns().every(function (t) {
                              e.s.dt.settings()[0].aoColumns[t].sTitle ===
                                  i.data && (i.dataIdx = t);
                          });
                })(s[i]);
            return t;
            ...
            if (
                ...
                if (
                    ...
                    for (
                        var i = [],
                            e = 0,
                            s = this.s.dt.settings()[0].aoColumns;
                        e < s.length;
                        e++
                    ) {
                        var r = s[e];
                        i.push(
                            r.searchBuilderType !== V
                                ? r.searchBuilderType
                                : r.sType
                        );
                    }
                ...
                (i === V || i.includes(V) || i.includes(null)) &&
                    (h.fn.dataTable.ext.oApi._fnColumnTypes(
                        this.s.dt.settings()[0]
                    ),
        ...
        (r.ext.buttons.searchBuilder = {
            action: function (t, i, e, n) {
                ...
                n !== V &&
                    n.dom.container.trigger("dtsb-redrawContents-noDraw"),
                    0 === n.s.criteria.length &&
                        s(
                            "." +
                                s.fn.dataTable.Group.classes.add.replace(
                                    / /g,
                                    "."
                                )
                        ).click();
            ...
            init: function (e, n, t) {
                ...
                e
                    ...
                    .text(
                        t.text ||
                            e.i18n("searchBuilder.button", i.c.i18n.button, 0)
                    ),
                    (t._searchBuilder = i);
            },
            text: null,
