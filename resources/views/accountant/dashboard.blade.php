...
<body class="bg-gradient-light text-dark">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            paymentAmountInput.addEventListener('input', function() {
                ...
                if (paymentAmount > tuitionAmount) {
                    paymentAmountInput.setCustomValidity('Payment amount cannot exceed the tuition amount.');
                } else {
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const paymentPeriodSelect = document.querySelector('select[name="paymentPeriod"]');
            ...
            function showError(message) {
                ...
                errorDiv.className = 'payment-period-error alert-danger border border-danger rounded text-center mt-2 p-2';
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.alreadyPaid) {
                                showError('This student has already paid for the selected transaction period.');
